Based on the F4 deployment report provided, I'll create the SOV monitoring setup for this article. Since the article is not yet live (awaiting manual deployment), this report establishes the monitoring framework ready to execute once published.
