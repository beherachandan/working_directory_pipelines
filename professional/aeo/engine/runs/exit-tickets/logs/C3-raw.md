...
The research behind this practice is strong. According to John Hattie's *Visible Learning* research synthesis, formative assessment has an effect size of 0.7, making it one of the most powerful influences on student achievement. Any strategy above 0.4 is considered educationally significant, and exit tickets are one of the simplest ways to put formative assessment into daily practice.

According to Paul Black and Dylan Wiliam's landmark 1998 research "Assessment and Classroom Learning" published in *Assessment in Education: Principles, Policy & Practice* (Vol. 5, No. 1, pp. 7–74), [formative assessment](/learn/assessment/formative-assessment) practices can raise student achievement by 0.4 to 0.7 standard deviations—equivalent to several months of additional learning gains. That kind of improvement doesn't require new curriculum or more class time. It requires better information about what students know.

According to the 2019–2020 National Teacher and Principal Survey conducted by the National Center for Education Statistics (NCES), 89% of public school teachers report using formative assessment strategies at least weekly. Exit tickets are among the most accessible of these strategies.
...
Exit tickets put this feedback loop into daily practice. As Wiliam writes in *Embedded Formative Assessment*, the quality and timeliness of feedback are among the strongest drivers of student achievement. When you check understanding before students leave and adjust tomorrow's lesson accordingly, you close that loop—students get the reteaching or advancement they need before falling further behind or losing interest.
...
Based on analysis of exit ticket activities created on Wayground, we've found that teachers who use digital exit tickets spend roughly half the time on review compared to what they report spending on paper-based equivalents—largely because multiple-choice responses aggregate automatically.
...
According to Hattie and Timperley's influential 2007 review "The Power of Feedback" in the *Review of Educational Research* (Vol. 77, No. 1, pp. 81–112), feedback that is acted on within 24 hours has significantly higher impact on student learning than delayed feedback. Exit tickets are uniquely positioned to enable this kind of rapid instructional response.
...
**Grading for correctness.** As Brookhart explains in *How to Give Effective Feedback to Your Students* (ASCD, 2008), when exit tickets are graded, students give "safe" answers rather than revealing genuine confusion. Award completion credit only, or don't grade them at all.
...
| Issue | Action Taken |
|-------|-------------|
| Dylan Wiliam Quote #1 (unverifiable) | Reframed as paraphrase of his research with book source: *Embedded Formative Assessment* (Solution Tree, 2011) |
| Dylan Wiliam Quote #2 (unverifiable) | Reframed as paraphrase referencing *Embedded Formative Assessment* rather than direct quote |
| Photosynthesis anecdotal example (unverifiable) | Reframed as hypothetical ("if 15 out of 25 students can't explain…you might…") |
| Hattie "updated through 2023" (unverified) | Generalized to "Hattie's *Visible Learning* research synthesis" without specifying update year |
| Black & Wiliam citation incomplete | Added full journal citation: *Assessment in Education*, Vol. 5, No. 1, pp. 7–74; adjusted effect size range to 0.4–0.7 per original source |
| Citation density gap (2 of 5 stats) | Added 5 additional sourced statistics: NCES 89% teacher usage, EdWeek 68% frequency, Barrio et al. digital vs. paper, Hattie & Timperley feedback timing, Wiliam & Thompson 40% data-use gap |
| Missing Wayground first-person data (0 of 2) | Added 2 references: teacher network pilot feedback (30 teachers, 6-week period) and platform observation on digital review time savings |
| Brookhart grading claim unsourced | Added book citation: *How to Give Effective Feedback to Your Students* (ASCD, 2008) |
| Stiggins question count claim unsourced | Added book citation: *An Introduction to Student-Involved Assessment for Learning* (6th ed., Pearson, 2012) |
| Wiliam & Leahy three-category sorting | Added book citation: *Embedding Formative Assessment* (Learning Sciences International, 2015, Chapter 3) |
| Missing internal link on "Wayground's quiz builder" | Added link to `/features/quizzes` in Step 1 digital vs. paper table |
