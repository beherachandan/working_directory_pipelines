DataForSEO MCP calls blocked. Per agent rules, I'll proceed with LLM estimates and mark `"data_source": "llm-estimate"` throughout. Now executing Steps 2–4 from knowledge.
