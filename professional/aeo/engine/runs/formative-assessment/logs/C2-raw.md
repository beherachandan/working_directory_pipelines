I'll create a comprehensive article outline based on the B3 brief. Note that C1's research packet is still pending (they requested web search access), but the brief provides detailed specifications for stats and quotes that I can map into the structure.
